...
<head>
    ...
    <title>Plano Básico - Seguro de Carro</title>
...
<nav class="navbar navbar-expand-md navbar-dark bg-primary">
    ...
    <div class="container main-content">
        <h2 class="text-center">Plano Básico de Seguro de Carro</h2>
        <div class="row justify-content-center">
            <div class="col-md-8">
                <!-- Card do Plano Básico Atualizado sem o preço -->
                <div class="plan">
                    <div class="inner">
                        <p class="title">Seguro de Carro Básico</p>
                        <p class="info">O Seguro de Carro Básico oferece proteção essencial para o seu veículo, cobrindo danos em caso de acidentes e roubos ou furtos. Ideal para quem busca um seguro mais acessível, com o mínimo de cobertura.</p>
                        ...
                        <ul class="features">
                            <li>
                                ...
                                <span><strong>Roubo e furto</strong></span>
                            </li>
                            <li>
                                <span class="icon">
                                    <svg height="24" width="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <span><strong>Assistência 24h em emergências</strong></span>
                            </li>
                        </ul>
                        ...
                        <ul class="features">
                            ...
                            <li>
                                ...
                                <span><strong>Cobertura adicional</strong></span>
                            </li>
                        </ul>
                        <div class="action">
